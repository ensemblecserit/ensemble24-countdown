export var StarFieldCanvas = (function (t) {
  var s = {};
  function i(e) {
  ...
  return (
    ...
    (i.c = s),
    (i.d = function (t, s, e) {
      i.o(t, s) || Object.defineProperty(t, s, { enumerable: !0, get: e });
    }),
    (i.r = function (t) {
  ...
  function (t, s, i) {
    ...
    class e {
      ...
      addTasks(t) {
        ...
        return 0 == t.length
          ? s
          : (t.forEach((t) => {
              this.frameTasks.push({ id: this.lastFrameTaskId, fn: t }),
                s.push(this.lastFrameTaskId),
      ...
      n = (function () {
        function t(t) {
          ...
          (this.ctx = s),
            ...
            (this.trails = c),
            (this.color = l || h),
            (this.splashLimitX = [-a, a]),
            (this.splashLimitY = [-n, n]),
            (this.addTasks = u),
            this.reset(!0);
        }
        return (
          (t.prototype.getInitialZ = function () {
          ...
          (t.prototype.draw = function (t, s) {
            ...
            this.trails &&
              ...
              (this.ctx.fillStyle =
                ...
                ")"),
              this.ctx.beginPath(),
              this.ctx.arc(i, e, n, 0, 2 * Math.PI),
              this.ctx.fill(),
              this.glow && this.ctx.restore(),
              (this.lastX = i),
              (this.lastY = e);
          }),
    ...
    var o = (function () {
      function t(t, s) {
        ...
        (this.color = s.color || h),
          (this.glow = s.glow || !1),
          (this.minV = s.minV || this.defaultMinV),
          (this.maxV = s.maxV || this.defaultMaxV),
          (this.numStars = this.defaultNumStars),
          (this.trails = s.trails || !1),
          (this.canvas = document.getElementById(t)),
          (this.ctx = this.canvas.getContext("2d"));
        var a = this.canvas.getBoundingClientRect();
        (this.canvasRectLeft = a.left),
          (this.canvasRectTop = a.top),
          (this.followContext = s.followContext || this.canvas),
          ...
          (this.numStars = s.numStars
            ? Math.abs(s.numStars)
            : this.defaultNumStars),
          this.setupCanvas(),
          this.generateStars(),
          (this.initialized = !0),
          s.followMouse && this.setFollowMouse(!0);
      }
      return (
        (t.prototype.generateStars = function () {
          for (var t = 0; t < this.numStars; t++)
            this.stars.push(
              new n({
                ctx: this.ctx,
                W: this.canvasW,
        ...
        (t.prototype.draw = function () {
          for (var t in (this.offsetX !== this.offsetTX &&
        ...
        (t.prototype.handleMouseMove = function (t) {
          this.initialized &&
            ((this.offsetTX =
              t.clientX - this.canvasRectLeft - this.canvasHalfW),
            (this.offsetTY =
              t.clientY - this.canvasRectTop - this.canvasHalfH));
        }),
